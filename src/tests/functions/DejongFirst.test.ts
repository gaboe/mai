...
it("is almost zero", () => {
  const val = evaluateFirstDejongFunction(0, 100);
  expect(val).toBeLessThan(0.00003);
});

it("is not NaN", () => {
  const val = evaluateFirstDejongFunction(-5.12, 10);
  expect(val).not.toBeNaN();

  const val2 = evaluateFirstDejongFunction(-2.12, 10);
  expect(val2).not.toBeNaN();

  const val3 = evaluateFirstDejongFunction(0, 100);
  expect(val3).not.toBeNaN();

  const val4 = evaluateFirstDejongFunction(2.12, 10);
  expect(val4).not.toBeNaN();

  const val5 = evaluateFirstDejongFunction(5.12, 10);
